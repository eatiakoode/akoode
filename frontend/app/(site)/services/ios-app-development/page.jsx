export const metadata = {
  title: 'Akoode - iOS App Development',
};
...
const InnerPageHero = dynamic(() => import('@/components/ios-app-development/InnerPageHero'), {
  ssr: false,
});
const AboutSection5 = dynamic(() => import('@/components/ios-app-development/AboutSection5'), {
  ssr: false,
});
const MobileAppSection = dynamic(
  () => import('@/components/ios-app-development/MobileAppSection'),
  { ssr: false }
);
const PeopleSection = dynamic(() => import('@/components/ios-app-development/PeopleSection'), {
  ssr: false,
});
const FAQSection = dynamic(() => import('@/components/ios-app-development/FAQSection'), {
  ssr: false,
});
        ...
        services={[
          {
            ...
            description:
              'Our experienced iOS developers create tailor-made applications tailored to fit your business needs. We guarantee that your custom iOS app reflects the brand identity and provides an enjoyable user experience, increasing engagement levels and driving growth for your company.',
          ...
          },
          {
            ...
            description:
              "Our team of talented UI/UX designers create visually appealing and intuitive interfaces with user satisfaction in mind, adhering to Apple's design guidelines and best practices for an even better experience across various devices.",
          ...
          },
          {
            ...
            description:
              'We seamlessly integrate your iOS app with existing systems and third-party services, providing enhanced functionality and an efficient data flow. Our developers make sure your application works perfectly across various APIs, frameworks, and platforms.',
          ...
          },
          {
            ...
            description:
              'Our thorough testing and quality assurance process guarantees your iOS app is free of bugs and offers an optimal user experience. We conduct extensive tests across multiple devices and configurations, guaranteeing the highest standards of quality assurance and reliable performance.',
          ...
          },
          {
            ...
            description:
              'Our team can assist you with updating your existing applications to the newest iOS versions or adding new features, helping your app remain relevant and competitive. We take a structured approach to migration and upgradation that minimizes disruption while providing an effortless transition.',
          ...
          },
          {
            ...
            description:
              'We provide ongoing maintenance and support services for your iOS app to keep it running optimally. Our team checks for issues, provides regular updates, and addresses any concerns promptly so your users have a smooth and hassle-free experience with no hassle.',
