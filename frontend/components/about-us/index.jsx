...
const index = () => {
  ...
  return (
    <>
      ...
      <section className="about-akoode mtop-80">
        <div className="container">
          {/* <div className="row">
            <div className="col-lg-8 offset-lg-2">
              <div className="main-title text-center">
                <h2 className="mt0 color-main">Face of akoode</h2>
                  ...
                  <div className="col-lg-7 col-md-12 order-2 order-lg-1">
                    <div className="who-we-are">
                          ...
                          <p><strong>Visionary Leadership</strong></p>
                              <p>Under Mr. Goyat’s forward-thinking leadership, <strong>akoode INFRAVENTURES PVT. LTD.</strong> has transformed into a client-centric, performance-driven real estate consultancy. His sharp market analysis, personalized approach, and strategic mindset have enabled the company to deliver tailored solutions that align with the financial goals and future aspirations of every client.
                              </p>
                    ...
                    <div className="who-we-are">
                          ...
                          {showFullBioAmit && (
                            <>
                              ...
                              <p><strong>Commitment to Relationships & Results</strong></p>
                              <p>With a reputation built on professionalism, market acumen, and ethical conduct, Mr. Amit Malik continues to guide clients with integrity and insight. His strong communication, result-oriented strategies, and commitment to service excellence make him a key pillar in <strong>akoode INFRAVENTURES PVT. LTD.</strong> continued growth.
                              </p>
                              <p><strong>Shaping the Future of Real Estate:</strong></p>
                              <p>Through his work at <strong>akoode INFRAVENTURES PVT. LTD.,</strong> Mr. Malik isn’t just facilitating commercial deals — he’s driving smart investments, fostering client trust, and helping shape sustainable prosperity in the real estate landscape.
                              </p>
                              <p><strong>Message:</strong></p>
                ...
                <div className="row align-items-center">
                  ...
                  <div className="col-lg-7 col-md-12 order-2 order-lg-1">
                    <div className="who-we-are">
                          ...
                          <p>Mr. Deepain Bansal, Associate Director at <strong>akoode INFRAVENTURES PVT. LTD.,</strong> is a well-established expert in the real estate sector with over 7 years of experience, specializing in residential properties and plotted developments across Delhi NCR. With a strong client-first approach and deep market understanding, Mr. Bansal has guided hundreds of homebuyers and investors in making smart, future-focused property decisions.</p>
                          ...
                          {showFullBioDeepain && (
                            <>
                              ...
                              <p>At <strong>akoode INFRAVENTURES,</strong> Mr. Bansal is not just closing deals—he’s building futures, helping clients make decisions that stand the test of time. His journey continues to inspire a new era of property ownership rooted in growth, reliability, and impact.
                              </p>
                              <p><strong>Message:</strong></p>
