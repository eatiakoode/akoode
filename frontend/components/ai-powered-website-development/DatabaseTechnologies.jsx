  ...
  const reasons = [
    {
      ...
      description: "Our skilled developers possess extensive expertise in creating AI-powered websites for various industries and niches."
    },
    {
      title: "Timely Delivery:",
      description: "We pledge to complete your project on schedule and within budget, without compromising quality."
    },
    {
      title: "Customer Support:",
      description: "Our knowledgeable customer support team is available to address your inquiries and concerns, ensuring a smooth development process."
    }
  ]
        ...
        <div className="row">
          <div className="col-lg-8 m-auto">
            <div className="heading8 text-center">
              <h2 className="text-anime-style-3">Why Choose Akoode Technologies for AI-Powered Website Development in Gurgaon?</h2>
