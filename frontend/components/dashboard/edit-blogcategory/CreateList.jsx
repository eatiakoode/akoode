  ...
  const params = useParams();
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        // router.push("/akoodeadmin/my-blogcategory");
    ...
    <form onSubmit={handleSubmit} className="row">
      ...
      <div className="col-xl-12">
        <div className="my_profile_setting_input">
          <button className="btn btn1 float-start" type="button" onClick={() => window.location.href = '/akoodeadmin/my-blogcategory'}>Back</button>
