...
export default function DatabaseTechnologies() {
  const reasons = [
    {
      title: "Expert Team:",
      description: "Our talented developers possess extensive expertise in creating full stack web applications for various industries and niches."
    },
    {
      title: "Timely Delivery:",
      description: "We guarantee timely completion of your project while staying within budget, without sacrificing quality."
    },
    {
      title: "Customer Support:",
      description: "Our knowledgeable customer support team is available to answer your queries and concerns, ensuring a seamless development process."
    }
  ]
        ...
        <div className="row">
          <div className="col-lg-8 m-auto">
            <div className="heading8 text-center">
              <h2 className="text-anime-style-3">Why Choose Akoode Technologies for Full Stack Website Development in Gurgaon?</h2>
