      ...
      <div className="hero-widget owl-carousel">
        <div className="hero-slider-boxarea">
          <div className="img1 image-anime">
            <img src="/images/roboai/slide-1.png" alt="image" className="img-fluid" />
          </div>
          <div className="container">
            <div className="hero1-header heading1">
              ...
              <div className="btn-area1" data-aos="fade-left" data-aos-duration="800">
                <a href="/contact" className="vl-btn1">
        ...
        <div className="hero-slider-boxarea">
          <div className="img1 image-anime">
            <img src="/images/roboai/slide-2.png" alt="image" className="img-fluid" />
          </div>
          <div className="container">
            <div className="hero1-header heading1">
              <h5 data-aos="fade-left" data-aos-duration="800">
              ...
              <div className="space16"></div>
              <p data-aos="fade-left" data-aos-duration="900">
                That Don't Just Adapt to Change—They Drive It.
                Unlock Growth, Innovate Faster, and Dominate Your Industry.
              </p>
              <div className="space32"></div>
              <div className="btn-area1" data-aos="fade-left" data-aos-duration="800">
                <a href="/contact" className="vl-btn1">
        ...
        <div className="hero-slider-boxarea">
          <div className="img1 image-anime">
            <img src="/images/roboai/slide-3.png" alt="image" className="img-fluid" />
          </div>
          <div className="container">
            <div className="hero1-header heading1">
              <h5 data-aos="fade-left" data-aos-duration="800">
              ...
              <div className="space16"></div>
              <p data-aos="fade-left" data-aos-duration="900">
                That Think, Learn, and Act. Empower
                Your Business to Solve Complex Problems with Precision and Speed.
              </p>
              <div className="space32"></div>
              <div className="btn-area1" data-aos="fade-left" data-aos-duration="800">
                <a href="/contact" className="vl-btn1">
