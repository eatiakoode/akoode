...
export default function DatabaseTechnologies() {
  const reasons = [
    {
      title: "Expert Team:",
      description: "Our skilled developers possess extensive expertise in creating static websites tailored to a variety of industries and niches."
    },
    {
      title: "Timely Delivery:",
      description: "We guarantee timely completion within budget, without compromising quality."
    },
    {
      title: "Customer Support:",
      description: "Our knowledgeable customer support team is available to answer your queries and concerns, ensuring a smooth development process."
    }
  ]
