...
export default function Service1SectionArea() {
  const services = [
    ...
    {
      id: 3,
      icon: "/images/ecommerce/magento.svg",
      title: "Magento Development",
      description: "Specializing in customized, scalable eCommerce solutions for businesses of all sizes using the powerful Magento platform."
    }
  ]
